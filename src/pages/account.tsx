		...
		<>
			...
			<main className='mx-auto max-w-6xl px-5 pt-24 pb-12 transition-all md:px-10'>
				...
				<div className="mt-6 grid grid-cols-1 gap-x-4 border px-4 py-4 md:grid-cols-4 md:border-x-0 md:border-t md:border-b-0 md:pb-0">
					...
					<p className="text-blue-500 hover:underline md:text-right cursor-pointer">Change Plan</p>
				</div>
				<div className="mt-6 grid grid-cols-1 gap-x-4 border px-4 py-4 md:grid-cols-4 md:border-x-0 md:border-t md:border-b-0 md:pb-0">
					<h4 className="text-lg text-[gray]">Settings</h4>
					<p className="col-span-2 cursor-pointer text-blue-500 hover:underline" onClick={logout}>Sign out of all devices</p>
				</div>
			</main>
		</>
	);
