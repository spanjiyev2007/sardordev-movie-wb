    ...
    return (
        <div className="min-h-screen">
            <div className="border-b-2 border-gray-300/20 h-[10vh] flex justify-between items-center px-4 md:px-10">
                ...
                <button onClick={logout} className="flex text-lg border p-2 rounded hover:bg-[#3b3b3b] transform hover:scale-110 transition duration-300"><MdLogout className=" h-7 w-7" />Logout</button>
            </div>
            ...
            <div className="flex justify-center items-center py-20">
                <div className="md:px-4 cursor-pointer md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0">
